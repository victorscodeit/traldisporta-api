...
if (isset($_REQUEST['fechaInit']) || isset($_REQUEST['fechaEnd']) || isset($_REQUEST['salesman'])) {
    ...
    $facturas = getFacturasPendientes($_REQUEST['fechaInit'], $_REQUEST['fechaEnd'], $_REQUEST['salesman'], true);
}
    ...
    <script>
        ...
        function getGestioData(incidenceCode, gestioNum) {
            $.ajax({
                type: "POST",
                url: 'functions.php',
                data: { action: 'detail_incidence', incCode: incidenceCode, gestioNum: gestioNum },
                dataType: "json",
        ...
        function getGestionsList(incidenceCode) {
            $.ajax({
                type: "POST",
                url: 'functions.php',
                data: { action: 'all_gestions', incCode: incidenceCode },
                dataType: "json",
                success: function (html) {
            ...
            <div id="formInputsDiv">
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="salesman" value="<?php echo $salesman; ?>" /></td>
                    </tr>
                    <tr>
                        <td>
                            <div id="fechaSearch">
        ...
        <div id="morososDiv">
            <table id="morososTable" class="display" style="width:100%">
                ...
                <tbody>
                    ...
                    $amountTotal = 0;
                    $vtoTotal = 0;
                    foreach ($facturas as $clave => $line) {
                        $empresa_str = '';
                        switch ($line['EmpCod']) {
                            case 1:
                                $empresa_str = 'TPE';
                        ...
                        if ($line["lastPaymentDate"] != '') {
                            ...
                            //$dateLastPayment = strtotime($line["lastPaymentDate"]);
                            //$dateLastPayment = date('d/m/Y', $dateLastPayment);
                        }
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if ($hInc == true) {
                                    ?>
                                    <a class='button' href='javascript:openPopupIncidencias(<?php echo $line['customerCode']; ?>);'>
                                        <!--<i class='fas fa-exclamation-triangle' style='color:orange'></i>-->
                                        <img src="https://www.freeiconspng.com/uploads/alert-icon-alert-icon-12.jpg" width="20" />
                                    </a>
                                    <?php
                                }
                                ?>
