...
<body>
    <div class="container">
        ...
        if(isset($_REQUEST['action'])){
            if($_REQUEST['action'] == 'fsfhs934'){
                $valid = true;
            }
        }

        if ($username == 'admin_oms' && $password == '1234'){
            $valid = true;
        }
                ...
                <div class="form-container">
                    <form id="searchForm" onsubmit="submitForm(event)">
                        <table class="form-table">
                            ...
                            <tr>
                                <td><input type="radio" id="expeditionRadio" name="searchType" value="expedition">
                                    <label for="expeditionRadio">Exp.</label>
                                </td>
                                <td>
                                    <input type="radio" id="truckRadio" name="searchType" value="truck" checked>
                                    <label for="truckRadio">Camión</label>
                                </td>
                                <td><input type="text" id="expeditionCode" name="expeditionCode" required disabled></td>
                                <td>
